...
export default async function BautagebuchPage() {
  ...
  const entries = await db
    .select({
      ...
      temperature: diaryEntries.temperature,
      workers: diaryEntries.workers,
      activities: diaryEntries.activities,
      notes: diaryEntries.notes,
      projectId: diaryEntries.projectId,
      projectName: projects.name,
    })
    .from(diaryEntries)
    .leftJoin(projects, eq(diaryEntries.projectId, projects.id))
